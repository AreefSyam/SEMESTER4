...
vr_data = pd.read_csv('D:\VISUAL STUDIO CODE\PYTHON\CNS3102_Python\Project\SERIOUS\VrData.csv')
...
dt_train_time, dt_test_time, dt_predictions = measure_time(dt_classifier, X_train, y_train, X_test)
...
knn_train_time, knn_test_time, knn_predictions = measure_time(knn_classifier, X_train, y_train, X_test)
...
svm_classifier = SVC()
svm_train_time, svm_test_time, svm_predictions = measure_time(svm_classifier, X_train, y_train, X_test)
